...
var BuildId = "2fdc9iGb9usCOh_xKvLso";
var HtmlPages = ["/404", "/500"];
var RoutesManifest = { "basePath": "", "rewrites": { "beforeFiles": [], "afterFiles": [], "fallback": [] }, "redirects": [{ "source": "/:path+/", "destination": "/:path+", "internal": true, "priority": true, "statusCode": 308, "regex": "^(?:/((?:[^/]+?)(?:/(?:[^/]+?))*))/$" }], "routes": { "static": [{ "page": "/", "regex": "^/(?:/)?$", "routeKeys": {}, "namedRegex": "^/(?:/)?$" }, { "page": "/_global-error", "regex": "^/_global\\-error(?:/)?$", "routeKeys": {}, "namedRegex": "^/_global\\-error(?:/)?$" }, { "page": "/_not-found", "regex": "^/_not\\-found(?:/)?$", "routeKeys": {}, "namedRegex": "^/_not\\-found(?:/)?$" }, { "page": "/api/workunit/tools", "regex": "^/api/workunit/tools(?:/)?$", "routeKeys": {}, "namedRegex": "^/api/workunit/tools(?:/)?$" }, { "page": "/favicon.ico", "regex": "^/favicon\\.ico(?:/)?$", "routeKeys": {}, "namedRegex": "^/favicon\\.ico(?:/)?$" }], "dynamic": [{ "page": "/api/workunit/[id]/action-preview", "regex": "^/api/workunit/([^/]+?)/action\\-preview(?:/)?$", "routeKeys": { "nxtPid": "nxtPid" }, "namedRegex": "^/api/workunit/(?<nxtPid>[^/]+?)/action\\-preview(?:/)?$" }, { "page": "/api/workunit/[id]/approval", "regex": "^/api/workunit/([^/]+?)/approval(?:/)?$", "routeKeys": { "nxtPid": "nxtPid" }, "namedRegex": "^/api/workunit/(?<nxtPid>[^/]+?)/approval(?:/)?$" }], "data": { "static": [], "dynamic": [] } }, "locales": [] };
...
var AppPathRoutesManifest = { "/_global-error/page": "/_global-error", "/_not-found/page": "/_not-found", "/api/workunit/[id]/action-preview/route": "/api/workunit/[id]/action-preview", "/api/workunit/[id]/approval/route": "/api/workunit/[id]/approval", "/api/workunit/tools/route": "/api/workunit/tools", "/favicon.ico/route": "/favicon.ico", "/page": "/" };
